...
"""autogenerated by genpy from paczka/poseRequest.msg. Do not edit."""
import codecs
import sys
...
class poseRequest(genpy.Message):
  _md5sum = "df30f7cddaf0839095c2022c165dd409"
  _type = "paczka/poseRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string tryb
float32[] q
"""
  __slots__ = ['tryb','q']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.tryb = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.tryb = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from paczka/poseResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
