...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trajektoria_wr' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/matsantos/catkin_ws/src/trajektoria_wr/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/matsantos/catkin_ws/devel/.private/trajektoria_wr/lib;/home/matsantos/catkin_ws/devel/lib;/opt/ros/melodic/lib)
